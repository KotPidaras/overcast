...
/obj/structure/stalker/radiation
	name = "radiation sign"
	desc = "Ýòîò çíàê çäåñü &#255;âíî íå äë&#255; êðàñîòû."
...
/obj/structure/stalker/radiation/stop
	name = "sign"
	desc = "Íà òàáëè÷êå íàïèñàíî - \"Ñòîï! Çàïðåòíà&#255; çîíà! Ïðîõîä çàïðåùåí!\"."
...
/obj/structure/stalker/water/luzha
	name = "puddle"
	desc = "Îáûêíîâåííà&#255; ëóæà. Âîäà, âðîäå áû, íå ñàìà&#255; ÷èñòà&#255;, íî óìûòüñ&#255; èëè ñìûòü îñòàòêè ãð&#255;çè ñ îäåæäû â íåé ìîæíî."
...
/obj/structure/stalker/cacheable/body
	name = "stalker's body"
	desc = "Ïîëóñãíèøèé òðóï ñòàëêåðà."
...
/obj/structure/stalker/cacheable/bochka
	name = "barrel"
	desc = "Æåëåçíà&#255; íåïðèìå÷àòåëüíà&#255; áî÷êà."
...
/obj/structure/stalker/water/bochka
	name = "barrel"
	desc = "Æåëåçíà&#255; áî÷êà, íàïîëíåííà&#255; äîæäåâîé âîäîé. Çäåñü ìîæíî óìûòüñ&#255; èëè ñìûòü îñòàòêè ãð&#255;çè."
	eng_desc = "Old steel barrel full of rainwater. You can wash your face oê clothes with it."
...
/obj/structure/stalker/cacheable/krest
	name = "cross"
	desc = "Äåðåâ&#255;ííûé êðåñò. Êàæåòñ&#255;, çäåñü êòî-òî çàêîïàí."
...
/obj/structure/stalker/cacheable/komod
	name = "komod"
	desc = "Îáûêíîâåííûé äåðåâ&#255;ííûé êîìîä."
...
/obj/structure/stalker/shina
	name = "tire"
	desc = "Ò&#255;æåëà&#255; ñòàðà&#255; ïðîáèòà&#255; øèíà."
...
/obj/structure/stalker/shina2
	name = "bunch of tires"
	desc = "Ò&#255;æåëûå ñòàðûå ïðîáèòûå øèíû."
...
/obj/structure/stalker/cacheable/switcher
	name = "switcher"
	desc = "Íåèñïðàâíûé âûêëþ÷àòåëü.\n<span class='notice'>Âû íà÷èíàåòå ùåëêàòü åãî è îáðåòàåòå íà íåêîòîðîå âðåì&#255; ïîêîé.</span>"
...
/obj/structure/stalker/doski
	name = "planks"
	desc = "Ñëîìàííûå äîñêè. Èñïîëüçîâàòü ãäå-ëèáî èõ óæå íå ïîëó÷èòñ&#255;."
...
/obj/structure/stalker/cacheable/battery
	name = "battery"
	desc = "Ðæàâà&#255; îòîïèòåëüíà&#255; áàòàðå&#255;. Êîãäà-òî ñîãðåâàëà äîìà, ñåé÷àñ - ïðîñòî î÷åðåäíà&#255; æåëåçêà."
...
/obj/structure/stalker/cacheable/vanna
	name = "bath"
	desc = "Ñòàðà&#255; ÷óãóííà&#255; âàííà. Íè÷åãî îñîáåííîãî."
...
/obj/structure/stalker/list
	...
	desc = "Ò&#255;æ¸ëûé æåñò&#255;ííîé ïîêîð¸æåííûé ëèñò. Èñïîëüçîâàòü åãî óæå íèêàê íå ïîëó÷èòñ&#255;."
...
/obj/structure/stalker/propane
	name = "propane"
	desc = "Áàëëîí ñ ïðîïàíîì. Îãíåîïàñíî. Íàâåðíîå."
...
/obj/structure/stalker/stolb
	...
	icon = 'icons/stalker/decorations_32x64.dmi'
	icon_state = "stolb"
	desc = "Ñòîëá ñ âèñ&#255;ùèìè îñòàòêàìè ïðîâîäîâ."
	eng_desc = "Old pillar."
	layer = 9
	density = 0
...
/obj/structure/stalker/cacheable/pen
	name = "stump"
	desc = "Îáû÷íûé ïåíü. Íè áîëüøå, íè ìåíüøå."
...
/obj/structure/stalker/cacheable/radio
	name = "radio"
	desc = "Ñòàðîå ñëîìàííîå ñîâåòñêîå ðàäèî."
...
/obj/structure/stalker/cacheable/cover
	...
	icon_state = "cover"
	desc = "Ñòàðûé êîâ¸ð. Îáû÷íî âèñèò íà ñòåíå."
...
/obj/structure/stalker/cacheable/porog
	...
	icon = 'icons/stalker/decor.dmi'
	icon_state = "porog1"
	desc = "Ñòàðûé ïîðîã, î êîòîðûé ìîæíî ëåãêî çàöåïèòüñ&#255; íîãîé."
	eng_desc = "Old step."
	layer = 2.9
	density = 0
	cache_size = 0
...
/obj/structure/stalker/cacheable/televizor
	name =  "TV-set"
	desc = "Ñòàðûé ñîâåòñêèé òåëåâèçîð."
...
/obj/structure/stalker/cacheable/painting/gorbachev
	name = "painting"
	desc = "Ïîðòðåò ïîñëåäíåãî ñåêðåòàð&#255; ÖÊ ÊÏÑÑ."
...
/obj/structure/stalker/cacheable/painting/stalin
	name = "painting"
	desc = "Ïîðòðåò âòîðîãî ñåêðåòàð&#255; ÖÊ ÊÏÑÑ."
...
/obj/structure/stalker/cacheable/painting/lenin
	name = "painting"
	desc = "Ïîðòðåò ïåðâîãî ñåêðåòàð&#255; ÖÊ ÊÏÑÑ."
...
/obj/structure/stalker/cacheable/televizor/broken
	icon_state = "TV_b"
	name =  "TV-set"
	desc = "Ñòàðûé ðàçáèòûé ñîâåòñêèé òåëåâèçîð."
	density = 1
	cache_size = 2
	pass_flags = LETPASSTHROW
...
/obj/structure/stalker/cacheable/shitok
	name = "switch box"
	desc = "Ñòàðûé ýëåêòðè÷åñêèé ùèòîê."
...
/obj/structure/stalker/lift
	name = "elevator"
	desc = "Ñòàðûé îîâåòñêèé ëèôò. Âåðî&#255;òíåå âñåãî îí óæå íèêîãäà íå çàðàáîòàåò."
	eng_desc = "Old soviet lift. It doesn't work anymore."
	icon_state = "lift"

/obj/structure/stalker/luk
	name = "hatch"
	desc = "Çàêðûòûé êàíàëèçàöèîííûé ëþê"
	icon = 'icons/stalker/decor2.dmi'
	icon_state = "luk0"

/obj/structure/stalker/luk/open
	desc = "Îòêðûòûé êàíàëèçàöèîíûé ëþê. Èíòåðåñíî, ÷òî âíóòðè?"
	icon_state = "luk1"

/obj/structure/stalker/luk/open/ladder
	desc = "Îòêðûòûé êàíàëèçàöèîííû ëþê ñ ëåñòíèöåé. Èíòåðåñíî, ÷òî âíóòðè?"
	icon_state = "luk2"

/obj/structure/stalker/trubas
	name = "pipe"
	desc = "Áîëüøà&#255; ðæàâà&#255; òðóáà, ñëóæèâøà&#255; äë&#255; ãàçîñíàáæåíè&#255;."
...
/obj/structure/stalker/cacheable/plita
	name = "stove"
	desc = "Ðæàâà&#255; è î÷åíü ñòàðà&#255; ãàçîâà&#255; ïëèòà. Ãäå-òî åùå ìîæíî ðàçëè÷èòü ñëîé çàñîõøåãî æèðà âïåðåìåøêó ñ ãð&#255;çüþ è ïûëüþ."
...
/obj/structure/stalker/cacheable/shkaf64
	name = "Shkaf"
	desc = "Áîëüøîé äåðåâ&#255;ííûé øêàô. Êðàñèâûé, íî â íåêîòîðûõ ìåñòàõ ñòåðñ&#255; è îáëåç, íà ñòåêëå ïîøëè òðåùèíû. Íåñìîòð&#255; íà ýòî, êàæåòñ&#255;, áóäòî âñåãî ïàðó ìèíóò íàçàä âíóòðè ñòî&#255;ë õðóñòàëüíûé áàáóøêèí ñåðâèç."
...
/obj/structure/stalker/cacheable
	name = "cache"
	desc = "Ãåíåðèðóåò òàéíèê ñ îïðåäåëåííûì øàíñîì â íà÷àëå ðàóíäà."
